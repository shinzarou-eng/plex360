...
set "INCLUDE=%XEDK%\include\xbox;%XEDK%\TechPreview\Jul12Compiler\include\xbox;%ROOT%%PROJ%\src"
...
echo [2/3] Link ^(PPCBE^)...
"%XBIN%\link.exe" /nologo /MACHINE:PPCBE /XEX:NO /STACK:262144,262144 /OUT:"%BINDIR%\%PROJ%.exe" %OBJS% %LIBS%
if errorlevel 1 goto :fail
